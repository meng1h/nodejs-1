...
var AsnDao =require('../../dao/storagein/AsnDao');

var AsnService = {};

//return promise
AsnService.find_detail_by_asnid=function(asn_id){

  var condition,selection;
  condition={asn_id:asn_id};
  selection ={asn_detail:1};
  return AsnDao.find_detail_by_asnid(condition,selection);
}
 
 //获取asn单据列表 promise
AsnService.find_asn_list = function(asn_statu,limit,offset,sort,order){
  ...
  return AsnDao.find_asn_list(condition,selection,limit,offset,sort,order);
}
