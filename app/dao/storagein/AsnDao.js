...
var AsnModel = require('../../models/storagein/AsnModel');
...
//根据ASN单据号查询明细
AsnDao.find_detail_by_asnid = function (condition,selection){
 ...
 * @return   {[Query]}                                                 [返回结果]
 */
AsnDao.find_asn_list =function (condition,selection,limit,offset,sort,order){
