var AsnService=require('../../service/storagein/AsnService');

exports.api = {
  find_detail_by_asnid : function(req,res,next){
    var asn_id= req.params.asn_id;
    if (asn_id)
    {
     AsnService.find_detail_by_asnid(asn_id).then(function(asndetail){
        return res.json(asndetail);
      });
    };
  },
  find_asn_list:function(req,res,next){
    ...
    AsnService.find_asn_list(asn_statu,pagesize*1,(pageno-1)*pagesize,"asn_id","asc")
